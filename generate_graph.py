...
def generate_graph(train_set_size,test_set_size):
    ...
    test_labels=np.copy(train_labels)

    for k in range(train_set_size-test_set_size):
    ...
    return adj_mat_train, train_data, train_labels, edge_pairs_train, test_data, test_labels
